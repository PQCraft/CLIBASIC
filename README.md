...
- If the file `.clibasic_history` is present in the user's home directory CLIBASIC will automatically save history there. Run `_AUTOCMDHIST` to enable this feature. Remove the file to disable this feature.
